...
ezek egyre súlyosodhatnak, ha nincsenek időben felmérve és megfelelően
javítva \cite{abedAnalysisPredictionPothole2023} .Ezt a jelenséget nevezzük kátyúnak, ami az útburkolat
...
\cite{millerDistressIdentificationManual2014}, \cite{safyariReviewVisionBasedPothole2024}.
...
\cite{yalewIMPACTPOTHOLEROAD2023}. Gazdasági szempontból a kátyúk jelentős pénzügyi terhet
...
kátyú detektálásra és javításra fordítani \cite{safyariReviewVisionBasedPothole2024}. „Ezenkívül a Világbank
...
\cite{martinez-riosReviewRoadSurface2022}
...
vagy egyáltalán észre se veszem a kátyút az úton és akarva akaratlanul
áthajtok rajta.

Meglátásom szerint kátyúk mindig is lesznek amíg javításuk ennyire drága
