...
videofolyamot feldolgozva, a képkockákon lévő kátyúkat felismerni,
detektálni (képen lévő helyüket bekeretezni).A kátyú detektálását követő lépés azok gépjárműhöz viszonyított, valós metrikus térbeli pozíciójának meghatározása. Ennek során a rendszer a kamerakép 2D-s koordinátáit valós, méterben kifejezett fizikai értékekké transzformálja, meghatározva ezzel a hibahely pontos oldalirányú távolságát. A lyukkamera modellre
...
lámpákat, közlekedési táblákat és nem a felfestéseket figyeli az
...
Videofolyam feldolgozás és
előfeldolgozás, a rendszer belépési pontja a valós idejű képfeldolgozó modul, amely a
...
által biztosított 2D videofolyamot. A feldolgozási lánc biztosítja, hogy
...
Kátyú detektálás, objektum
felismerés modul a rendszer szeme, amely a vizuális információk értelmezéséért
...
reakcióidőt a sofőr vagy egy későbbi autonóm rendszer számára.
 ...
 Térbeli Lokalizáció és
Koordináta-transzformáció a rendszer legfontosabb matematikai modulja, amely a detektált
objektumokat elhelyezi a valós térben a járműhöz viszonyítva.

2D-ből 3D transzformációhoz a lyukkamera-modell
